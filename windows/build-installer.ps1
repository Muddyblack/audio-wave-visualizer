# Builds Audio-Visualizer-Setup-<version>.exe (repository root) from
# PyInstaller's "dist\Audio Visualizer" folder with Inno Setup — see
...
python -c "from PIL import Image; Image.open('package/icon.png').convert('RGBA').save('dist/audio-visualizer.ico', sizes=[(16, 16), (24, 24), (32, 32), (48, 48), (64, 64), (128, 128), (256, 256)])"
